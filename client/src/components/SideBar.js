const SideBar = () => {
  return (
    <div className="side-nav side-nav-light side-nav-expand bg-[#d7e5f5] min-w-[290px]">
      <div className="side-nav-header h-16 flex items-center bg-blue-400">
      ...
      <div className="side-nav-content"></div>
    </div>
  );
};
